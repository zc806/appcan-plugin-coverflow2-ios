...
NSComparisonResult compareViewDepthCover(UIView *view1, UIView *view2, iCarouselCoverFlow2 *self);
...
@implementation iCarouselCoverFlow2
...
- (void)depthSortViews
{
    for (UIView *view in [[itemViews allValues] sortedArrayUsingFunction:(NSInteger (*)(id, id, void *))compareViewDepthCover context:(__bridge void *)self])
    {
