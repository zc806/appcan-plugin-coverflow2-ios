...
@interface iCarouselCoverFlow2 : UIView
...
- (UIView *)carousel:(iCarouselCoverFlow2 *)carousel viewForItemAtIndex:(NSUInteger)index reusingView:(UIView *)view;

@optional

- (NSUInteger)numberOfPlaceholdersInCarousel:(iCarouselCoverFlow2 *)carousel;
- (UIView *)carousel:(iCarouselCoverFlow2 *)carousel placeholderViewAtIndex:(NSUInteger)index reusingView:(UIView *)view;
...
- (UIView *)carousel:(iCarouselCoverFlow2 *)carousel viewForItemAtIndex:(NSUInteger)index __deprecated;
- (UIView *)carousel:(iCarouselCoverFlow2 *)carousel placeholderViewAtIndex:(NSUInteger)index __deprecated;
...
- (void)carouselWillBeginScrollingAnimation:(iCarouselCoverFlow2 *)carousel;
- (void)carouselDidEndScrollingAnimation:(iCarouselCoverFlow2 *)carousel;
- (void)carouselDidScroll:(iCarouselCoverFlow2 *)carousel;
- (void)carouselCurrentItemIndexUpdated:(iCarouselCoverFlow2 *)carousel;
...
- (CGFloat)carouselOffsetMultiplier:(iCarouselCoverFlow2 *)carousel;
...
- (CATransform3D)carousel:(iCarouselCoverFlow2 *)carousel itemTransformForOffset:(CGFloat)offset baseTransform:(CATransform3D)transform;
- (CGFloat)carousel:(iCarouselCoverFlow2 *)carousel valueForTransformOption:(iCarouselTranformOption)option withDefault:(CGFloat)value;

//deprecated, use transformForItemAtIndex:withOffset:baseTransform: instead
- (CATransform3D)carousel:(iCarouselCoverFlow2 *)carousel transformForItemView:(UIView *)view withOffset:(CGFloat)offset __deprecated;
